...
{
   public class MewLabsConnectedClient : IDisposable
    {
        //the parent server
        MewLabsServer _server;
        ...
        internal MewLabsConnectedClient(Guid clientId, MewLabsServer server, TcpClient dataStream)
        {
            _server = server;
            _clientID = clientId;
